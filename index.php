...
<script>
		...
		<main id="center" class="column">
			<article>
				...
				by 20% for the same case of beer in a single geographic location. cheapbeerprices.com aims to inform you which store is the cheapest for 
				the beverage that you are looking for. </p>
